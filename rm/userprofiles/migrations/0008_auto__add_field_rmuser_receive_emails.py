...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RMUser.receive_emails'
        db.add_column(u'userprofiles_rmuser', 'receive_emails',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RMUser.receive_emails'
        db.delete_column(u'userprofiles_rmuser', 'receive_emails')
    ...
    models = {
        u'userprofiles.rmuser': {
            ...
            'receive_emails': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
