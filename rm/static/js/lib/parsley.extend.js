...
(function ($) {
  window.ParsleyConfig = $.extend( true, {}, window.ParsleyConfig, {
    validators: {
      ...
      , greaterthanorequalto: function ( val, elem, self ) {
        self.options.validateIfUnchanged = true;
      ...
      ,rmafterdate: function( val, elem, self){
        return Date.parse($(elem).val().replace(/(\d{2})\/(\d{2})\/(\d{4})/, "$2/$1/$3")) < Date.parse(val.replace(/(\d{2})\/(\d{2})\/(\d{4})/, "$2/$1/$3"));
      }
    ...
    , messages: {
      ...
      , greaterthanorequalto:    "This value should be greater than or equal to %s."
      , lessthan:       "This value should be less than %s."
      , beforedate:     "This date should be before %s."
      , afterdate:      "This date should be after %s."
      , rmafterdate:    "This date should be after %s."
