...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trial.ending_style'
        db.alter_column(u'trials_trial', 'ending_style', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Trial.instruction_delivery'
        db.alter_column(u'trials_trial', 'instruction_delivery', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Trial.ending_style'
        db.alter_column(u'trials_trial', 'ending_style', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Trial.instruction_delivery'
        db.alter_column(u'trials_trial', 'instruction_delivery', self.gf('django.db.models.fields.TextField')(max_length=2))
