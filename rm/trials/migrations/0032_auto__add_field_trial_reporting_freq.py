...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.reporting_freq'
        db.add_column(u'trials_trial', 'reporting_freq',
                      self.gf('django.db.models.fields.CharField')(default='da', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.reporting_freq'
        db.delete_column(u'trials_trial', 'reporting_freq')
