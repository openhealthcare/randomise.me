...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.group_a_desc'
        db.add_column(u'trials_trial', 'group_a_desc',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trial.group_b_desc'
        db.add_column(u'trials_trial', 'group_b_desc',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Trial.description'
        db.alter_column(u'trials_trial', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Trial.group_a_desc'
        db.delete_column(u'trials_trial', 'group_a_desc')

        # Deleting field 'Trial.group_b_desc'
        db.delete_column(u'trials_trial', 'group_b_desc')


        # User chose to not deal with backwards NULL issues for 'Trial.description'
        raise RuntimeError("Cannot reverse this migration. 'Trial.description' and its values cannot be restored.")
