...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.ending_style'
        db.add_column(u'trials_trial', 'ending_style',
                      self.gf('django.db.models.fields.TextField')(default='ma'),
                      keep_default=False)

        # Adding field 'Trial.ending_reports'
        db.add_column(u'trials_trial', 'ending_reports',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trial.ending_date'
        db.add_column(u'trials_trial', 'ending_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.ending_style'
        db.delete_column(u'trials_trial', 'ending_style')

        # Deleting field 'Trial.ending_reports'
        db.delete_column(u'trials_trial', 'ending_reports')

        # Deleting field 'Trial.ending_date'
        db.delete_column(u'trials_trial', 'ending_date')
    ...
    models = {
        ...
        u'trials.participant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 31, 0, 0)', 'blank': 'True'}),
            'trial': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trials.Trial']"}),
        ...
        u'trials.trial': {
            ...
            'ending_style': ('django.db.models.fields.TextField', [], {'default': "'ma'"}),
