...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrialAnalysis.stderrmeana'
        db.add_column(u'trials_trialanalysis', 'stderrmeana',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TrialAnalysis.stderrmeanb'
        db.add_column(u'trials_trialanalysis', 'stderrmeanb',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrialAnalysis.stderrmeana'
        db.delete_column(u'trials_trialanalysis', 'stderrmeana')

        # Deleting field 'TrialAnalysis.stderrmeanb'
        db.delete_column(u'trials_trialanalysis', 'stderrmeanb')
    ...
    models = {
        ...
        u'trials.participant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 20, 0, 0)', 'blank': 'True'}),
            'trial': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trials.Trial']"}),
        ...
        u'trials.trial': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 20, 0, 0)'}),
        ...
        u'trials.trialanalysis': {
            ...
            'stderrmeana': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'stderrmeanb': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'trial': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trials.Trial']"})
        },
