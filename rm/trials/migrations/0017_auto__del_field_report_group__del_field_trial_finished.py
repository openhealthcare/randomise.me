...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'trials_report', 'group')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Report.group'
        raise RuntimeError("Cannot reverse this migration. 'Report.group' and its values cannot be restored.")
