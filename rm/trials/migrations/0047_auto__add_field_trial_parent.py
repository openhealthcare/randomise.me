...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.parent'
        db.add_column(u'trials_trial', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child', null=True, to=orm['trials.Trial']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.parent'
        db.delete_column(u'trials_trial', 'parent_id')
