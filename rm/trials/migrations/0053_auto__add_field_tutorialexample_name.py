...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TutorialExample.name'
        db.add_column(u'trials_tutorialexample', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TutorialExample.name'
        db.delete_column(u'trials_tutorialexample', 'name')
