...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.group'
        db.alter_column(u'trials_participant', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trials.Group'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Participant.group'
        raise RuntimeError("Cannot reverse this migration. 'Participant.group' and its values cannot be restored.")
    ...
    models = {
        ...
        u'trials.trial': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'})
        }
    }
