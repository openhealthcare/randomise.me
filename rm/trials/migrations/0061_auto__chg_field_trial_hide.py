...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trial.hide'
        db.alter_column(u'trials_trial', 'hide', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Trial.hide'
        db.alter_column(u'trials_trial', 'hide', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'trials.participant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)', 'blank': 'True'}),
            'trial': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trials.Trial']"}),
        ...
        u'trials.trial': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)'}),
            ...
            'hide': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'trials.trialanalysis': {
            ...
            'pval': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
