...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.created'
        db.add_column(u'trials_trial', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 29, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.created'
        db.delete_column(u'trials_trial', 'created')
