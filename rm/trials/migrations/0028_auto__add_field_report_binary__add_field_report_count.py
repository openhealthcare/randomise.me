...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.binary'
        db.add_column(u'trials_report', 'binary',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Report.count'
        db.add_column(u'trials_report', 'count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.binary'
        db.delete_column(u'trials_report', 'binary')

        # Deleting field 'Report.count'
        db.delete_column(u'trials_report', 'count')
