...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.reporting_date'
        db.add_column(u'trials_trial', 'reporting_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.reporting_date'
        db.delete_column(u'trials_trial', 'reporting_date')
    ...
    models = {
        ...
        u'trials.trial': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
