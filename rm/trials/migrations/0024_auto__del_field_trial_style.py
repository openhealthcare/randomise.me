...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trial.style'
        db.delete_column(u'trials_trial', 'style')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Trial.style'
        raise RuntimeError("Cannot reverse this migration. 'Trial.style' and its values cannot be restored.")
