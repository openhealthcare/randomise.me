...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Trial', fields ['url']
        db.delete_unique(u'trials_trial', ['url'])


    def backwards(self, orm):
        # Adding unique constraint on 'Trial', fields ['url']
        db.create_unique(u'trials_trial', ['url'])
