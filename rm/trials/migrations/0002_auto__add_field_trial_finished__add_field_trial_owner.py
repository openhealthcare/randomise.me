...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.finished'
        db.add_column(u'trials_trial', 'finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Trial.owner'
        db.add_column(u'trials_trial', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.finished'
        db.delete_column(u'trials_trial', 'finished')

        # Deleting field 'Trial.owner'
        db.delete_column(u'trials_trial', 'owner_id')
