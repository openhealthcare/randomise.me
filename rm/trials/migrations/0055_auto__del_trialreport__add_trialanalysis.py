...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'TrialReport'
        db.delete_table(u'trials_trialreport')

        # Adding model 'TrialAnalysis'
        db.create_table(u'trials_trialanalysis', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trials.Trial'])),
            ('power_small', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('power_med', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('power_large', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('mean', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('sd', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'trials', ['TrialAnalysis'])


    def backwards(self, orm):
        # Adding model 'TrialReport'
        db.create_table(u'trials_trialreport', (
            ('power_small', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('trial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trials.Trial'])),
            ('power_large', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('power_med', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'trials', ['TrialReport'])

        # Deleting model 'TrialAnalysis'
        db.delete_table(u'trials_trialanalysis')
