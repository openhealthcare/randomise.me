...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'trials_report', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trials.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.group'
        db.delete_column(u'trials_report', 'group_id')
