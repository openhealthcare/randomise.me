...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'trials_report', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Report.date'
        raise RuntimeError("Cannot reverse this migration. 'Report.date' and its values cannot be restored.")
