...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SingleUserReport.date'
        db.add_column(u'trials_singleuserreport', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 6, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SingleUserReport.date'
        db.delete_column(u'trials_singleuserreport', 'date')
