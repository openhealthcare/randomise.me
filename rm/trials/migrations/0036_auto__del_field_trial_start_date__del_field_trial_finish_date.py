...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trial.start_date'
        db.delete_column(u'trials_trial', 'start_date')

        # Deleting field 'Trial.finish_date'
        db.delete_column(u'trials_trial', 'finish_date')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Trial.start_date'
        raise RuntimeError("Cannot reverse this migration. 'Trial.start_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Trial.finish_date'
        raise RuntimeError("Cannot reverse this migration. 'Trial.finish_date' and its values cannot be restored.")
