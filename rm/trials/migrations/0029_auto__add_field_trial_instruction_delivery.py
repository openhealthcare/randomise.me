...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.instruction_delivery'
        db.add_column(u'trials_trial', 'instruction_delivery',
                      self.gf('django.db.models.fields.TextField')(default='im', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.instruction_delivery'
        db.delete_column(u'trials_trial', 'instruction_delivery')
