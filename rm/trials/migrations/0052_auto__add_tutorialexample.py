...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TutorialExample'
        db.create_table(u'trials_tutorialexample', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('measure_style', self.gf('django.db.models.fields.CharField')(default='sc', max_length=2)),
            ('measure_question', self.gf('django.db.models.fields.TextField')()),
            ('group_a', self.gf('django.db.models.fields.TextField')()),
            ('group_b', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'trials', ['TutorialExample'])


    def backwards(self, orm):
        # Deleting model 'TutorialExample'
        db.delete_table(u'trials_tutorialexample')
    ...
    models = {
        ...
        u'trials.participant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 12, 0, 0)', 'blank': 'True'}),
            'trial': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trials.Trial']"}),
        ...
        u'trials.trial': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 12, 0, 0)'}),
