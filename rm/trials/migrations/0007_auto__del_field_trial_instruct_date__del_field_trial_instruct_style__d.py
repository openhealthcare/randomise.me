...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trial.instruct_date'
        db.delete_column(u'trials_trial', 'instruct_date')

        # Deleting field 'Trial.instruct_style'
        db.delete_column(u'trials_trial', 'instruct_style')

        # Deleting field 'Trial.instruct_hour'
        db.delete_column(u'trials_trial', 'instruct_hour')


    def backwards(self, orm):
        # Adding field 'Trial.instruct_date'
        db.add_column(u'trials_trial', 'instruct_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Trial.instruct_style'
        raise RuntimeError("Cannot reverse this migration. 'Trial.instruct_style' and its values cannot be restored.")
        # Adding field 'Trial.instruct_hour'
        db.add_column(u'trials_trial', 'instruct_hour',
